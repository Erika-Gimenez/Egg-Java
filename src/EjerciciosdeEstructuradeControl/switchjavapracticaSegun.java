 ...
 * @author ale
 */
public class switchjavapracticaSegun {
    ...
    public static void main(String[] args) {
       Scanner leer = new Scanner(System.in);
        System.out.println("Inventario de motor de bomba de fluido");
        System.out.println("Ingresa un  valor para saber si hay stock"); 
